...
#ifndef PDQSORT_USE_CPP11
#if __cplusplus >= 201103L || _MSC_VER > 1500
#define PDQSORT_USE_CPP11 1
#else
#define PDQSORT_USE_CPP11 0
#endif
#endif

#if defined(PDQSORT_USE_CPP11)
    #include <cstdint>
    #include <type_traits>
...
#if defined(UINTPTR_MAX) && defined(PDQSORT_USE_CPP11)
